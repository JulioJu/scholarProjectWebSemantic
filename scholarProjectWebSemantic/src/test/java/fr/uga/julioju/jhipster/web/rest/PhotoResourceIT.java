...
public class PhotoResourceIT {
    ...
    private static final byte[] DEFAULT_FIN_THUMBNAIL = TestUtil.createByteArray(1, "0");
    private static final byte[] UPDATED_FIN_THUMBNAIL = TestUtil.createByteArray(1, "1");
    private static final String DEFAULT_FIN_THUMBNAIL_CONTENT_TYPE = "image/jpg";
    private static final String UPDATED_FIN_THUMBNAIL_CONTENT_TYPE = "image/png";
    ...
    public static Photo createEntity(EntityManager em) {
        Photo photo = new Photo()
            .name(DEFAULT_NAME)
            .finThumbnail(DEFAULT_FIN_THUMBNAIL)
            .finThumbnailContentType(DEFAULT_FIN_THUMBNAIL_CONTENT_TYPE);
        // Add required entity
    ...
    public void createPhoto() throws Exception {
        ...
        assertThat(testPhoto.getFinThumbnail()).isEqualTo(DEFAULT_FIN_THUMBNAIL);
        assertThat(testPhoto.getFinThumbnailContentType()).isEqualTo(DEFAULT_FIN_THUMBNAIL_CONTENT_TYPE);
    }
    ...
    public void getAllPhotos() throws Exception {
        ...
        restPhotoMockMvc.perform(get("/api/photos?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].finThumbnailContentType").value(hasItem(DEFAULT_FIN_THUMBNAIL_CONTENT_TYPE)))
            .andExpect(jsonPath("$.[*].finThumbnail").value(hasItem(Base64Utils.encodeToString(DEFAULT_FIN_THUMBNAIL))));
    }
    ...
    public void getPhoto() throws Exception {
        ...
        restPhotoMockMvc.perform(get("/api/photos/{id}", photo.getId()))
            ...
            .andExpect(jsonPath("$.finThumbnailContentType").value(DEFAULT_FIN_THUMBNAIL_CONTENT_TYPE))
            .andExpect(jsonPath("$.finThumbnail").value(Base64Utils.encodeToString(DEFAULT_FIN_THUMBNAIL)));
    }
    ...
    public void updatePhoto() throws Exception {
        ...
        updatedPhoto
            .name(UPDATED_NAME)
            .finThumbnail(UPDATED_FIN_THUMBNAIL)
            .finThumbnailContentType(UPDATED_FIN_THUMBNAIL_CONTENT_TYPE);
        ...
        assertThat(testPhoto.getFinThumbnail()).isEqualTo(UPDATED_FIN_THUMBNAIL);
        assertThat(testPhoto.getFinThumbnailContentType()).isEqualTo(UPDATED_FIN_THUMBNAIL_CONTENT_TYPE);
    }
