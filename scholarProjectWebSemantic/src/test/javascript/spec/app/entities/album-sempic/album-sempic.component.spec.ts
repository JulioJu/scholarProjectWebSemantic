...
import { AlbumSempicComponent } from 'app/entities/album-sempic/album-sempic.component';
...
describe('Component Tests', () => {
  describe('AlbumSempic Management Component', () => {
    let comp: AlbumSempicComponent;
    let fixture: ComponentFixture<AlbumSempicComponent>;
    let service: AlbumSempicService;

    beforeEach(() => {
      TestBed.configureTestingModule({
        imports: [ScholarProjectWebSemanticTestModule],
        declarations: [AlbumSempicComponent],
        providers: [
          {
        ...
        .overrideTemplate(AlbumSempicComponent, '')
        .compileComponents();

      fixture = TestBed.createComponent(AlbumSempicComponent);
