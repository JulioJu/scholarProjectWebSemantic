...
import { PhotoSempicComponent } from 'app/entities/photo-sempic/photo-sempic.component';
...
describe('Component Tests', () => {
  describe('PhotoSempic Management Component', () => {
    let comp: PhotoSempicComponent;
    let fixture: ComponentFixture<PhotoSempicComponent>;
    let service: PhotoSempicService;

    beforeEach(() => {
      TestBed.configureTestingModule({
        imports: [ScholarProjectWebSemanticTestModule],
        declarations: [PhotoSempicComponent],
        providers: [
          {
        ...
        .overrideTemplate(PhotoSempicComponent, '')
        .compileComponents();

      fixture = TestBed.createComponent(PhotoSempicComponent);
